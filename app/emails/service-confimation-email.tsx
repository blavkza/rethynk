...
export default function ServiceConfirmationEmail({
  name,
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            ...
            <Section className="bg-gray-50 rounded-lg p-6 my-6">
              ...
              <Text className="text-black-600 text-[16px] font-bold">
                Budget Range
              </Text>
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              1. Our team will reach out to you within 48 hours to schedule an
